...
```
```{r plot_wine_quality, echo=FALSE, fig.cap="밀도 그래프를 사용한 레드 와인과 화이트 와인의 품질 비교", fig.align="center", out.width="90%"}
...
```
```{r plot_wine_alchohol_vs_quality, echo=FALSE, fig.cap="와인의 알코올 농도와 품질 간의 관계", fig.align="center", out.width="90%"}
